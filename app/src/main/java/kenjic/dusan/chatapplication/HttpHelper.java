...
/**
 * Created by Duuuuuc on 5/16/2018.
 */
...
public class HttpHelper {
    ...
    public boolean registerUserOnServer(Context context, String urlString, JSONObject jsonObject) throws IOException{
        ...
        try {
            ...
            Log.d(TAG, "registerUserOnServer: exception");
            return false;
        }
        ...
        Log.d(TAG, "registerUserOnServer: " + SUCCESS);
        return (responseCode==SUCCESS);
    }

    public boolean deleteFromServer(Context context, String urlString)  throws IOException, JSONException {
        ...
        String responseMsg = urlConnection.getResponseMessage();
        String registerErr = Integer.toString(responseCode) + " : " + responseMsg;
        editor.putString("deleteContactErr", registerErr);
